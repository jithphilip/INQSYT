...
chunks_df = pd.read_json(os.path.join(ws_dir, "Main_Data", "Chunks", "chunks_v1.jsonl"), lines=True)
...
index = faiss.read_index(os.path.join(GEN_DIR, "faiss_index_v1_linearized.bin"))
...
with open(os.path.join(ws_dir, "scratch", "eval_v4_failures.json"), "w") as f:
    json.dump(evaluation_report, f, indent=2)
print(f"Saved failure details to scratch/eval_v4_failures.json")
