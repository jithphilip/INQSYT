# 📊 RAG Evaluation & Failure Analysis Report (Iteration 4: LR Dataset v2 + Local Qwen)
...
| :--- | :---: | :---: | :--- | :--- |
| **NLU Classifier Misclassification** | NLU Classifier/Logistic Regression | 15 / 48.4% | The logistic regression model failed to include the true intent in the top 3 predicted intents. | Add more varied training data for these specific intents. |
| **LLM Router Fallback Error** | LLM Router/Few-Shot Fallback | 1 / 3.2% | The local Qwen 7B model failed to select the correct intent during fallback routing. | Adjust few-shot examples or switch to a larger model. |
| **Reranking / Ranking Failure** | Reranker/Cross-Encoder | 15 / 48.4% | The router correctly identified the intent, but the dense chunks confused the reranker. | Execute the Chunk Optimization strategy (chunks_cleaned). |
...
- **Root Cause**: The router correctly identified the intent, but the Cross-Encoder scored irrelevant chunks higher than the true chunk.
<!-- slide -->
...
- **Root Cause**: The LR model confidently predicted ['check_shipping_policies', 'track_package', 'modify_order'] instead of modify_address.
<!-- slide -->
...
- **Isolated Component**: NLU Classifier/Logistic Regression
- **Root Cause**: The LR model confidently predicted ['check_tax_rates'] instead of view_invoice.
<!-- slide -->
...
- **Isolated Component**: NLU Classifier/Logistic Regression
- **Root Cause**: The LR model confidently predicted ['report_missing_package', 'check_shipping_policies', 'track_package'] instead of submit_feedback.
<!-- slide -->
...
- **Isolated Component**: NLU Classifier/Logistic Regression
- **Root Cause**: The LR model confidently predicted ['modify_address', 'manage_notifications'] instead of manage_profile_settings.
<!-- slide -->
...
- **Isolated Component**: NLU Classifier/Logistic Regression
- **Root Cause**: The LR model confidently predicted ['modify_address', 'manage_profile_settings', 'reset_password'] instead of manage_account_settings.
<!-- slide -->
...
- **Isolated Component**: NLU Classifier/Logistic Regression
- **Root Cause**: The LR model confidently predicted ['manage_wallet_cards'] instead of resolve_declined_payment.
<!-- slide -->
...
- **Isolated Component**: NLU Classifier/Logistic Regression
- **Root Cause**: The LR model confidently predicted ['check_restocking_fees'] instead of check_return_eligibility.
<!-- slide -->
...
- **Isolated Component**: NLU Classifier/Logistic Regression
- **Root Cause**: The LR model confidently predicted ['manage_notifications', 'modify_order', 'modify_address'] instead of manage_delivery_alerts.
<!-- slide -->
...
- **Isolated Component**: NLU Classifier/Logistic Regression
- **Root Cause**: The LR model confidently predicted ['modify_address', 'report_missing_item', 'report_missing_package'] instead of resolve_undeliverable_package.
<!-- slide -->
...
- **Isolated Component**: NLU Classifier/Logistic Regression
- **Root Cause**: The LR model confidently predicted ['resolve_declined_payment', 'check_delivery_delay', 'report_missing_item'] instead of resolve_undeliverable_package.
<!-- slide -->
...
- **Isolated Component**: NLU Classifier/Logistic Regression
- **Root Cause**: The LR model confidently predicted ['report_missing_package', 'check_shipping_policies', 'report_missing_item'] instead of check_delivery_rules.
<!-- slide -->
...
- **Isolated Component**: LLM Router/Few-Shot Fallback
- **Root Cause**: The local Qwen model did not output the true intent in its JSON response.
<!-- slide -->
...
- **Isolated Component**: NLU Classifier/Logistic Regression
- **Root Cause**: The LR model confidently predicted ['check_international_returns'] instead of check_tax_rates.
<!-- slide -->
...
- **Isolated Component**: NLU Classifier/Logistic Regression
- **Root Cause**: The LR model confidently predicted ['view_invoice'] instead of check_tax_rates.
<!-- slide -->
...
- **Isolated Component**: NLU Classifier/Logistic Regression
- **Root Cause**: The LR model confidently predicted ['manage_account_settings', 'manage_delivery_alerts'] instead of manage_notifications.
````
