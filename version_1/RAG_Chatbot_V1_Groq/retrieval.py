...
def load_retrieval_resources():
    chunks_df = pd.read_json(os.path.join(CURRENT_DIR, "data", "chunks.jsonl"), lines=True)
    embedder = SentenceTransformer("BAAI/bge-base-en-v1.5")
    index = faiss.read_index(os.path.join(CURRENT_DIR, "data", "faiss_index.bin"))
